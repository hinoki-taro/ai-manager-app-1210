...
SYSTEM_PROMPT_DOC_SEARCH = """
    ...
    - 文脈に質問と関連する情報が全く含まれていない場合：
      ...
      2. 以下の形式で回答してください：「申し訳ございませんが、{トピック}に関する資料は見つかりませんでした。担当部門へ直接問い合わせてくださいますよう、お願いいたします。」
...
SYSTEM_PROMPT_INQUIRY = """
    ...
    - 文脈に質問と関連する情報が全く含まれていない場合：
      1. ユーザーの質問から主要なトピック/キーワードを抽出してください
      2. 以下の形式で回答してください：「申し訳ございませんが、{トピック}に関する情報は提供できません。担当部門へ直接問い合わせてくださいますよう、お願いいたします。」
      3. 例: 質問が「昇格試験の過去問について教えてください」→「申し訳ございませんが、昇格試験の過去問に関する情報は提供できません。担当部門へ直接問い合わせてくださいますよう、お願いいたします。」
    - 部分的に情報がある場合は、得られる情報だけでも回答し、「さらに詳しい情報については文書内に記載がありません」と補足してください。
